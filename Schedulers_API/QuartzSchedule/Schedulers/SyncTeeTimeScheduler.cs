...
{
    public class SyncTeeTimeScheduler
    {
        private readonly ILogger<SyncTeeTimeScheduler> _logger;
        private readonly IScheduler _scheduler;
        //private AppSettings _appSettings;

        public SyncTeeTimeScheduler(ILogger<SyncTeeTimeScheduler> logger,
        ...
        public Task SyncTeeTimeJob()
        {
            var jobDetails = JobBuilder
                .CreateForAsync<SyncTeeTimeJob>()
                .WithIdentity("SyncTeeTimeJob")
                .WithDescription("싱크 티타임 스케쥴")
                .Build();
